package md5d0bdf4c8aa56c5769c3fb63f86a27410;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FFImageLoading.Cache.LRUCache, FFImageLoading.Platform, Version=2.4.3.840, Culture=neutral, PublicKeyToken=null", LRUCache.class, __md_methods);
	}
	...
	public LRUCache (int p0)
	{
		...
		if (getClass () == LRUCache.class)
			mono.android.TypeManager.Activate ("FFImageLoading.Cache.LRUCache, FFImageLoading.Platform, Version=2.4.3.840, Culture=neutral, PublicKeyToken=null", "System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0 });
	}
